...
function Multiparser(request, opts) {
  ...
  // limiting the chunkSize keeps memory usage nice and tight
...
Multiparser.prototype.onPartData = function (b, start, end, cb) {
  var written = this.part.write(b.slice(start, end))
  cb(written)
}

Multiparser.prototype.onPartEnd = function () {
  this.part.end()
}
